    ...
    return (
        <section className='w-10/12 mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 min-h-[calc(100vh-200px)]'>
            <div className='flex flex-col justify-center' >
                ...
                <p className='text-gray-600 pr-4'>Welcome to ToyNirvana, your one-stop-shop for endless fun and play! Our wide selection of toys caters to kids of all ages and interests. We have something for everyone. Our toys are carefully selected for their quality, safety, and ability to inspire creativity and imagination. Come explore our world of play and discover endless fun at ToyNirvana!</p>

                <div>
                <button className='px-6 py-2 mt-4 font-bold text-white bg-[#219EBC] rounded-lg '>Browse Now</button>
                </div>
