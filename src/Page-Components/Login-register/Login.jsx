...
const Login = () => {
    ...
    return (
        <div className='mt-16 w-10/12 sm:w-8/12 lg:w-6/12 mx-auto border rounded-lg py-10 shadow-lg bg-slate-100'>
            ...
            <form className='w-10/12 mx-auto mt-8'>
            ...
            <p className='text-center mt-4 text-gray-500'>Don't have an Account? <span onClick={()=>navigate('/register')} className='text-[#219EBC] font-bold'>Sign Up</span> here</p>
